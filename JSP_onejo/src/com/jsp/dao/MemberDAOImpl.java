...
public class MemberDAOImpl implements MemberDAO{
	...
	@Override
	public MemberVO selectMemberByNickName(SqlSession sqlSession, String nickName) throws Exception {
		MemberVO member = sqlSession.selectOne("Member-Mapper.selectMemberByNickName",nickName);
		return member;
	}
