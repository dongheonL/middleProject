...
<c:set var="nomalAffairsBoardList" value="${dataMap.nomalAffairsBoardList }" />
...
<div class="title_area">
	...
	<h2 class="pageTitle"
		style="margin-left: 20px; font-family: 'Jeju Gothic';">일반직인사</h2>
	<!-- 페이지 입력 밑 -->
	<div class="location">
		...
		<span class="f_nav">인사정보</span> <span class="tit"><strong
			style="text-decoration: underline; font-weight: bold;">일반직인사 - 2021.1.1.자 지방공무원 인사발령 예고</strong></span>
		<!-- 페이지 입력 밑 -->
	</div>
</div>
<!-- title_area end -->
	...
	<div class="cntBody clearfix">
		...
		<div class="board-text">
			<table class="wb">
				...
				<tbody>
					<c:if test="${!empty nomalAffairsBoardList }">
						<c:forEach items="${nomalAffairsBoardList }" var="nomalAffairsBoard">
							...
							<tr onmouseover="this.style.backgroundColor='#EFF8FF'"
								...
								style="padding: 20px;">
								<td>${nomalAffairsBoard.bno }</td>
								<td class="link text-center"><a
									href="detail.do?bno=${nomalAffairsBoard.bno }&from=list" border="0"
									title=${nomalAffairsBoard.title } style="text-decoration: none;">${nomalAffairsBoard.title }
								</a></td>
								<td><c:if test="${!empty nomalAffairsBoard.nomalAffairsAttachList}">
										<img
								...
								<td>${nomalAffairsBoard.viewcnt }</td>
								<td><fmt:formatDate value="${nomalAffairsBoard.regDate }"
			...
			<div class="card-footer" style="background: white;">
				...
				<div style="display:${!empty nomalAffairsBoardList ? 'visible' : 'none' };">
