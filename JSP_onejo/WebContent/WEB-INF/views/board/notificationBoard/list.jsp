...
<div class="title_area">
	...
	<h2 class="pageTitle"
		style="margin-left: 20px; font-family: 'Jeju Gothic';">알림방</h2>
	<!-- 페이지 입력 밑 -->
	<div class="location">
		<i class="fa-solid fa-house" style="font-size: 25px; color: black;"></i>
		<span class="f_nav">정보마당</span> 
		<span class="f_nav">소식알림방</span> <span class="tit"><strong
			style="text-decoration: underline; font-weight: bold;">알림방</strong></span>
		<!-- 페이지 입력 밑 -->
	</div>
