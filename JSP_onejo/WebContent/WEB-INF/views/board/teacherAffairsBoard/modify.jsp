					...
					<div class="card  card-primary">
						...
						<div class="card-body">
							<form enctype="multipart/form-data" role="form" method="post"
								...
								<input type="hidden" name="bno" value="${teacherAffairsBoard.bno }" />
								<input type="text" id="writer" hidden="" name="writer"
									class="form-control" value="${teacherAffairsBoard.writer }">

								<div class="form-group">
									<label for="title">제 목</label> <input type="text" id="title"
										name='title' class="form-control" placeholder="제목을 쓰세요"
										value="${teacherAffairsBoard.title }">
								</div>
								<div class="form-group">
									<label for="content">내 용</label>
									<textarea class="form-control" name="content" id="content"
										rows="5" placeholder="1000자 내외로 작성하세요.">
										${fn:escapeXml(teacherAffairsBoard.content) }
										</textarea>
								</div>
								<div class="form-group">
									<div class="card">
											...
											<div class="card-footer fileInput">
												<ul
													...
													<c:forEach items="${teacherAffairsBoard.teacherAffairsAttachList }" var="teacherAffairsAttach">
														<li class="attach-item thumb${teacherAffairsAttach.ano}"
															file-name="${teacherAffairsAttach.fileName }"
															target-ano="${teacherAffairsAttach.ano }">
															<div class="mailbox-attachment-info ">
																...
																<a class="mailbox-attachment-name" name="attachedFile"
																	...
																	<i class="fas fa-paperclip"></i> ${teacherAffairsAttach.fileName }&nbsp;&nbsp;
																	<button type="button"
																		onclick="removeFile_go('thumb${teacherAffairsAttach.ano}');return false;"
