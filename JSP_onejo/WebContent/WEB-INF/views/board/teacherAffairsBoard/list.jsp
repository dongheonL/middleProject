...
<c:set var="teacherAffairsBoardList" value="${dataMap.teacherAffairsBoardList }" />
...
<div class="title_area">
	...
	<h2 class="pageTitle"
		style="margin-left: 20px; font-family: 'Jeju Gothic';">교원인사</h2>
	<!-- 페이지 입력 밑 -->
	<div class="location">
		<i class="fa-solid fa-house" style="font-size: 25px; color: black;"></i>
		<span class="f_nav">정보마당</span> 
		<span class="f_nav">인사정보</span> <span class="tit"><strong
	...
	<div class="cntBody clearfix">
		...
		<div class="board-text">
			<table class="wb">
				...
				<tbody>
					<c:if test="${!empty teacherAffairsBoardList }">
						<c:forEach items="${teacherAffairsBoardList }" var="teacherAffairsBoard">
							...
							<tr onmouseover="this.style.backgroundColor='#EFF8FF'"
								...
								style="padding: 20px;">
								<td>${teacherAffairsBoard.bno }</td>
								<td class="link text-center"><a
									href="detail.do?bno=${teacherAffairsBoard.bno }&from=list" border="0"
									title=${teacherAffairsBoard.title } style="text-decoration: none;">${teacherAffairsBoard.title }
								</a></td>
								<td><c:if test="${!empty teacherAffairsBoard.teacherAffairsAttachList}">
										<img
								...
								<td>${teacherAffairsBoard.viewcnt }</td>
								<td><fmt:formatDate value="${teacherAffairsBoard.regDate }"
			...
			<div class="card-footer" style="background: white;">
				...
				<div style="display:${!empty teacherAffairsBoardList ? 'visible' : 'none' };">
