...
<c:set var="appointmentBoardList" value="${dataMap.appointmentBoardList }" />
...
<!-- title_area start -->
	<div class="title_area">
		...
		<div class="location">
			...
			<span class="tit"><strong>임용시험</strong></span>
			<!-- 페이지 입력 밑 -->
		</div>
         ...
         <div class="inform_bg mb20"></div>
            ...
            <div>
			 ...
			 <div class="board-text">
			     ...
			     <tbody>
			               <c:forEach items="${appointmentBoardList }"  var="appointmentBoard">
								...
								style="padding: 20px;">
								<td>${appointmentBoard.bno }</td>
								<td id="boardTitle" style="text-align:left;max-width: 100px; overflow: hidden;
								  white-space: nowrap; text-overflow: ellipsis;">
									<a href="javascript:submit_go('detail.do?bno=${appointmentBoard.bno}&from=list','상세보기');">
										<span class="col-sm-12 ">${appointmentBoard.title }</span>
									</a>
					     	   </td>
								
								<td><c:if test="${!empty appointmentBoard.appointmentAttachList}">
									...
									<c:if test="${empty appointmentBoard.appointmentAttachList}">
										 <span>-</span>
									</c:if>
									
								</td>
								<td>${appointmentBoard.writer }</td>
								<td><fmt:formatDate value="${appointmentBoard.regDate }" pattern="yyyy-MM-dd" /></td>
								<td>${appointmentBoard.viewcnt }</td>
							    </tr>		
							</c:forEach>		
			          <c:if test="${empty appointmentBoardList}">
							<tr>
				...
				<div class="card-footer" style="background: white;">
					...
					<div style="display:${!empty appointmentBoardList ? 'visible' : 'none' };">
